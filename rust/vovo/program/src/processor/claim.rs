...
struct Accounts<'a, 'b: 'a> {
    ...
    depositor_pot_token: &'a AccountInfo<'b>,
    depositor_pot: &'a AccountInfo<'b>,
...
fn parse_accounts<'a, 'b: 'a>(
    ...
    let accounts = Accounts {
        ...
        depositor_pot_token: next_account_info(account_iter)?,
        depositor_pot: next_account_info(account_iter)?,
    ...
    assert_owned_by(accounts.depositor_pot_token, &spl_token::id())?;
    assert_owned_by(accounts.depositor_pot, program_id)?;
